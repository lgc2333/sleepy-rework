...
export default defineConfig({
  ...
  shortcuts: {
    'text-primary': 'text-op-90 text-gray-900 dark:text-white',
    'text-lighter': 'text-op-90 text-gray-700 dark:text-gray-300',
    ...
    indicator:
      '[&[online="true"]]:bg-[var(--color-online)]' +
      ' [&[online="true"]]:color-[var(--color-online)]' +
      ' [&[online="false"]]:bg-[var(--color-offline)]' +
      ' [&[online="false"]]:color-[var(--color-offline)]',
  },
  theme: {},
})
